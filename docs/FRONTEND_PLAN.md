...
console should help a person answer five questions quickly:
...
[ALIGNMENT_PLAN.md](ALIGNMENT_PLAN.md), [API.md](API.md), and
...
### E — add and maintain material

1. Open Operations.
2. Submit ingest or choose generation/source/maintenance actions.
...
| `#/operations` | Create/maintain | Ingest, generation, refresh, starter, tidy/revive, jobs |
